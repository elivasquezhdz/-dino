...
imgElement.onload = function() {
  console.log("Start process") ;
    ...
    cv.imshow('mask',MASKU);
      ...
      let sprites = cv.imread(document.getElementById("offline-resources-1x-img"));
    ...
    for (let i = 0; i <  rotate.rows; i++) {
      ...
      mask_mat.delete(); rotate.delete(); bg.delete(); frame.delete(); frame2.delete(); frame1.delete();
    ...
    async function delete_images(){
        ...
        img.src = "";
        //let nearsprites = document.getElementById("offline-resources-1x-img"); 
        //nearsprites.src = "";
        ...
        i =document.getElementById("rect"); i.width=1; i.height=1;
        i =document.getElementById("rect1"); i.width=1; i.height=1;
        i =document.getElementById("rect2"); i.width=1; i.height=1;
        i =document.getElementById("swapcolors"); i.width=1; i.height=1;
